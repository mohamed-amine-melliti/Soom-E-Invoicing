  ...
  <q-card id="pragmatic" class="theme">
    <div class="header row">
      <div class="column col-md-7 col-lg-7 col-sm-7 col-xs-7 q-pa-lg">
        <div class="text-h4 text-weight-bold">Facture</div>
        <div class="editable text-h6 text-grey q-mt-md" data-name="name">Votre Nom / Nom du  Business </div>
        <div class="editable text-subtitle text-grey q-mt-md" data-name="address">Votre Address</div>
        <div class="editable text-subtitle text-grey q-mt-sm" data-name="city">Ville</div>
        <div class="editable text-subtitle text-grey q-mt-sm" data-name="country">Pays</div>
        <div class="editable text-subtitle text-grey q-mt-sm" data-name="postal">Code Postale </div>
      </div>
    ...
    <q-card-section class="q-pa-lg">
      <div class="row">
        <div class="">
          <div class="text-weight-bold text-uppercase">Facturer:</div>
          <div class="editable text-h6" data-name="company_name">Company Name</div>
          <div class="editable text-subtitle text-grey q-mt-sm" data-name="company_address">Addresse</div>
          <div class="editable text-subtitle text-grey q-mt-sm" data-name="company_city">Ville</div>
          <div class="editable text-subtitle text-grey q-mt-sm" data-name="company_country">Pays</div>
          <div class="editable text-subtitle text-grey q-mt-sm" data-name="company_postal">Code Postale</div>
          <div class="editable text-subtitle text-grey q-mt-sm" data-name="vat_no">Vat Number</div>
        </div>
        <q-space />
        <div class="text-right">
          <div class="text-weight-bold text-uppercase">Facture #</div>
